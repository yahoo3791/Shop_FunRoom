  ...
  <div class="container d-none d-md-flex mb-5" id="deluxeDouble">
    <div class="left w-100">
      <div class="roomPic overflow-hidden" style="height: 567px">
        <img src="@/assets/pic/single02.png" class="w-100 h-100" style="object-fit: cover" alt="" />
      </div>
    </div>
    <div class="right d-flex flex-column ms-2 w-100">
      ...
      <div class="roomPic w-100" style="margin-top: 10px">
        <img
          src="@/assets/pic/single03.png"
          class="w-100"
          style="height: 284px; object-fit: cover; overflow: hidden; object-position: 0 -300px"
          alt=""
        />
      </div>
    </div>
