    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active overflow-hidden w-100" style="height:210px">
          <img src="@/assets/pic/single01.jpg" class="d-block w-100" style="object-fit:cover;" alt="...">
        </div>
        <div class="carousel-item overflow-hidden w-100" style="height:210px">
          <img src="@/assets/pic/single02.jpg" class="d-block w-100" style="object-fit:cover;object-position:0px -150px" alt="...">
        </div>
        <div class="carousel-item overflow-hidden w-100" style="height:210px">
          <img src="@/assets/pic/single03.jpg" class="d-block w-100" style="object-fit:cover;object-position:0px -200px" alt="...">
        </div>
      </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 d-flex justify-content-between align-items-center">
                <div class="box">
                  <h2 class="fs-4 article_h2">Single Room</h2>
                </div>
                <div class="box">
                  <div class="left">
  ...
  <div class="container d-none d-md-flex mb-5" id="deluxeDouble">
    <div class="left w-100">
      <div class="roomPic overflow-hidden" style="height:567px;">
        <img src="@/assets/pic/single02.jpg" class="w-100 h-100" style="object-fit:cover" alt="">
      </div>
    </div>
    <div class="right d-flex flex-column ms-2 w-100">
      <div class="roomPic w-100" style="margin-top: -10px;">
        <img src="@/assets/pic/single01.jpg" class="w-100" style="height:284px; object-fit: cover; overflow: hidden;"
          alt="">
      </div>
      <div class="roomPic w-100" style="margin-top: 10px;">
        <img src="@/assets/pic/single03.jpg" class="w-100" style="height:284px; object-fit: cover; overflow: hidden;object-position: 0 -300px;"
          alt="">
      </div>
    </div>
  </div>
        ...
        <div class="article">
          <div class="article_content">
            <div class="article_title pb-2 d-flex justify-content-between">
              <h2 class="article_h2">Single Room</h2>
