<template>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active overflow-hidden w-100" style="height:210px">
          <img src="@/assets/pic/double01.jpg" class="d-block w-100" style="object-fit:cover;" alt="...">
        </div>
        <div class="carousel-item overflow-hidden w-100" style="height:210px">
          <img src="@/assets/pic/double02.jpg" class="d-block w-100" style="object-fit:cover;object-position:0px -150px" alt="...">
        </div>
        <div class="carousel-item overflow-hidden w-100" style="height:210px">
          <img src="@/assets/pic/double03.jpg" class="d-block w-100" style="object-fit:cover;object-position:0px -150px;" alt="...">
        </div>
      </div>
    ...
    <div class="collapse_sm container-fluid">
      <div class="row" style="background:#F1F1F1;">
        ...
        <div class="col-6" :class="{ 'border-b': isIntroduction }">
          ...
          <!-- <a href="#/room/deluxedouble/CommentReview" href="#collapseExample2" @click.prevent="checkEvaluation()"
            class="border-0 fs-6 btn d-block" data-bs-toggle="collapse" role="button" aria-expanded="false"
            aria-controls="collapseExample"><span class="d-block">房客評價(128)</span></a> -->
        </div>
      </div>
      <p>
      </p>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 d-flex justify-content-between align-items-center">
                <div class="box">
                  <h2 class="fs-4 article_h2">Double Room</h2>
                </div>
                <div class="box">
                  <div class="left">
              ...
              <div class="col-7 ">
                <div class="row content_span">
                  ...
                  <div class="col-7 col-md-7">
                    <p class="fw-bolder">人數限制</p>
                  </div>
                  <div class="col-5 col-md-5">
                    <p>1</p>
                  </div>
                  <div class="col-7 col-md-7">
                    <p class="fw-bolder">床型</p>
                  </div>
                  <div class="col-5 col-md-5">
                    <p>單人床</p>
                  </div>
                  <div class="col-7 col-md-7">
                    <p class="fw-bolder">衛浴數量</p>
                  </div>
                  <div class="col-5 col-md-5">
                    <p>1</p>
                  </div>
                  <div class="col-7 col-md-7">
                    <p class="fw-bolder">房間大小</p>
                  </div>
                  <div class="col-5 col-md-5">
                    <p>18平方公尺</p>
                  </div>
              ...
              <div class="col-5 content_span">
                <div class="col-12">
                  <h3 class="fs-5 pb-2">入住/退房時間</h3>
                </div>
                <div class="col-sm-6 col-md-6">
                  <p class="fw-bolder">入住時間</p>
                </div>
                <div class="col-sm-6 col-md-6">
                  <p class="">15:00~21:00</p>
                </div>
                <div class="col-sm-12 col-md-6">
                  <p class="fw-bolder">退房時間</p>
                </div>
                <div class="col-sm-12 col-md-6">
                  <p class="">10:00以前</p>
                </div>
              ...
              <div class="col-12 my-3">
                <button class="primaryBtn" @click="reservematerial()">預訂房間</button>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="container d-none d-md-flex mb-5" id="deluxeDouble">
    <div class="left w-100">
      <div class="roomPic overflow-hidden" style="height:567px;">
        <img src="@/assets/pic/double03.jpg" class="w-100 h-100" style="object-fit:cover" alt="">
      </div>
    </div>
    <div class="right d-flex flex-column ms-2 w-100">
      <div class="roomPic w-100" style="margin-top: -10px;">
        <img src="@/assets/pic/double02.jpg" class="w-100" style="height:284px; object-fit: cover; overflow: hidden;"
          alt="">
      </div>
      <div class="roomPic w-100" style="margin-top: 10px;">
        <img src="@/assets/pic/double01.jpg" class="w-100" style="height:284px; object-fit: cover; overflow: hidden;"
          alt="">
      </div>
    </div>
  </div>
  <div class="container d-none d-md-flex justify-content-between mb-5">
    <div class="row">
      <div class="col-7">
        <div class="article">
          <div class="article_content">
            <div class="article_title pb-2 d-flex justify-content-between">
              <h2 class="article_h2">Double Room</h2>
          ...
          <div class="row mt-5">
            <div class="col-6">
              <div class="article_news row">
                <div class="col-12">
                  <h3 class="article_news_h3 fs-5 pb-2">房間資訊</h3>
                </div>
                <div class="col-6">
                  <p>人數限制</p>
                </div>
            ...
            <div class="col-6">
              <div class="article_time row">
                <div class="col-12">
                  <h3 class="article_time_h3 fs-5 pb-2">入住/退房時間</h3>
                </div>
                <div class="col-6">
                  <p>入住時間</p>
                </div>
  ...
  <reservematerialModal ref="reservematerialModal" @click="xx($event)"></reservematerialModal>
  <CheckMaterialModal ref="CheckMaterialModal"></CheckMaterialModal>
  <CommentReview_md ref="CommentReview_md"></CommentReview_md>
</template>
...
export default {
  ...
  methods: {
    ...
    xx(e) {
      console.log(123);
      console.log(e.target.innerText === "預訂房間");
      if (e.target.innerText === "預訂房間") {
        this.$refs.reservematerialModal.hideModal();
        this.$refs.CheckMaterialModal.showModal();
      }
    },
    openCommentModal() {
